...
print("Welcome to The Fishy Coin Collector. Are you up for this challenge? "
      "Collect the coins but watch out for the spikes!")
print("Get ready...")
...
class MyGame(arcade.Window):
    ...
    def __init__(self):
        ...
        self.bad_hit_sound = arcade.sound.load_sound(":resources:sounds/lose1.wav")
    ...
    def setup(self):
        ...
        # Create the Coins
        for i in range((COIN_COUNT - 25)):
            # Spike image from Brass Badger Workshop
            coin = Coin("1.png", COIN_SCALE * 0.5)
            ...
            while not coin_placed_successfully:
                ...
                # See if the coin is hitting another coin
                coin_hit_list = arcade.check_for_collision_with_list(coin, self.spike_list)
    ...
    def on_draw(self):
        ...
        arcade.draw_text(f"You have {self.coin_count} coins to collect!",
                         160,
                         70,
                         arcade.color.WHITE, 16,
                         anchor_x="center")
        arcade.draw_text(f"You have {self.score} coins collected!",
                         160,
                         50,
                         arcade.color.WHITE, 16,
                         anchor_x="center")
        arcade.draw_text(f"You have {self.lives} life remaining!",
                         20,
                         30,
                         arcade.color.WHITE, 16)
        ...
        if self.lives != 0:
            if len(self.coin_list) != 0:
                ...
                for spike in self.spike_list:
                    good_hit_list = arcade.check_for_collision_with_list(spike, self.player_list)
